...
.hero-ratings{display:flex;gap:8px;margin-top:16px;flex-wrap:wrap}
.hero-rating-item{background:white;border:1px solid var(--border);border-radius:8px;padding:8px 12px;display:flex;align-items:center;gap:8px}
.hero-rating-item .r-val{font-size:18px;font-weight:800;color:var(--primary)}
.hero-rating-item .r-lbl{font-size:10px;color:var(--text-muted);text-transform:uppercase;font-weight:600;letter-spacing:0.2px}
...
<div class="hero-rating-item"><span class="r-val">{overall if overall else 'N/A'}</span><span class="r-lbl">Overall</span></div>
<div class="hero-rating-item"><span class="r-val">{health_insp if health_insp else 'N/A'}</span><span class="r-lbl">Health</span></div>
<div class="hero-rating-item"><span class="r-val">{quality_rating if quality_rating else 'N/A'}</span><span class="r-lbl">Quality</span></div>
<div class="hero-rating-item"><span class="r-val">{staffing_rating if staffing_rating else 'N/A'}</span><span class="r-lbl">Staffing</span></div>
</div>
</div>
