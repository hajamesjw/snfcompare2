...
.qm-type.qm-section-great{color:#115e59;background:linear-gradient(90deg,#f0fdfa,#ccfbf1)}.qm-type.qm-section-great::before{background:#0d9488}
...
.qm-table tr.qm-great td:first-child::before{background:#0d9488}
...
.qm-great{color:#0d9488;font-weight:600}
