...
.hero-badge{display:inline-flex;align-items:center;gap:6px;background:linear-gradient(135deg,#ecfdf5,#d1fae5);color:#065f46;padding:6px 14px;border-radius:20px;font-size:11px;font-weight:600;border:1px solid rgba(16,185,129,0.2)}
.hero-badge svg{width:14px;height:14px}
.hero h1{font-size:28px;font-weight:800;color:var(--text);margin-bottom:12px;letter-spacing:-0.5px;line-height:1.2}
.hero .address{color:var(--text-muted);font-size:14px;margin-bottom:6px;display:flex;align-items:flex-start;gap:8px}
.hero .address svg{width:16px;height:16px;opacity:0.5;flex-shrink:0;margin-top:2px}
...
.hero .phone svg{width:16px;height:16px;opacity:0.5}
.hero-stats{display:flex;gap:16px;margin-top:16px;flex-wrap:wrap}
.hero-stat{background:white;border:1px solid var(--border);border-radius:10px;padding:10px 14px;text-align:center;min-width:70px}
.hero-stat .stat-val{font-size:18px;font-weight:800;color:var(--primary)}
.hero-stat .stat-lbl{font-size:9px;color:var(--text-muted);text-transform:uppercase;font-weight:600;letter-spacing:0.3px}
...
@media(max-width:700px){.hero{padding:24px 0}.hero-grid{grid-template-columns:1fr;gap:20px}.hero-image{order:-1}.hero-image img{height:200px}.hero h1{font-size:22px}.hero-top{flex-direction:column;align-items:flex-start;gap:12px}.hero-stats{gap:10px}.hero-stat{padding:8px 12px;min-width:60px}.hero-stat .stat-val{font-size:16px}}
...
<div class="hero-info">
<div class="hero-top">
{f'<div class="hero-rating"><div class="rating-num">{overall}/5</div><div class="rating-label">CMS Rating</div></div>' if overall else ''}
...
<div class="hero-stat"><div class="stat-val">{health_insp if health_insp else 'N/A'}</div><div class="stat-lbl">Health</div></div>
<div class="hero-stat"><div class="stat-val">{quality_rating if quality_rating else 'N/A'}</div><div class="stat-lbl">Quality</div></div>
<div class="hero-stat"><div class="stat-val">{staffing_rating if staffing_rating else 'N/A'}</div><div class="stat-lbl">Staffing</div></div>
</div>
</div>
